...
$results = [];
try {
    $stmt = $pdo->prepare("SELECT * FROM section_images WHERE section_name = 'mca_results' ORDER BY display_order ASC, uploaded_at DESC");
    $stmt->execute();
...
<head>
    ...
    <title>MCA Results | Infomaths</title>
    <meta name="description" content="View our outstanding MCA entrance results">
    ...
    <style>
        ...
        .result-img {
            ...
            width: 100%;
            height: 100%;
            object-fit: cover; /* or contain if text is important, usually result images are text heavy so contain might be better, let's stick to cover for gallery feel but maybe add lightbox */
...
<body>
    ...
    <section class="page-hero text-center">
        <div class="container position-relative z-1">
            <h1 class="display-4 fw-bold mb-3 text-white mt-5">MCA Results</h1>
            <p class="lead text-white-50 mb-0">Celebrating the success of our students in MCA entrances</p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Results will be uploaded soon.</p>
                </div>
            <?php endif; ?>
        </div>
    </section>
