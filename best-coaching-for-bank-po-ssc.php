...
try {
    ...
    $sql = "SELECT title as course_name, is_active FROM bank_po_course_profiles WHERE is_active = 1 ORDER BY display_order ASC, title ASC";
    $stmt = $pdo->query($sql);
...
$entranceExams = [];
try {
    $sql = "SELECT * FROM bank_po_entrance_exams WHERE is_active = 1 ORDER BY display_order ASC, exam_name ASC";
    $stmt = $pdo->query($sql);
...
// Fallback to default static list if database is empty - REMOVED AS REQUESTED
...
<body>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mb-5 mb-lg-0 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="pro-breadcrumb">
                        ...
                        <span class="pro-breadcrumb-item active">Bank PO & SSC Prep</span>
                    </div>

                    <h1 class="pro-banner-title">Master Your Bank PO & SSC Journey</h1>
                    <p class="pro-tagline">
    ...
    <section style="background-color:#f7f7f8;">
        <div class=" td_height_112 td_height_lg_75">
        </div>
        <div class="container">
                    ...
                    <div class="td_iconbox td_style_2 text-center td_hobble">
                        <div class="td_iconbox_in td_hover_layer_4">
                            <div class="td_hover_layer_3">
                                ...
                                <h3 class="td_iconbox_title td_fs_20 td_semibold td_opacity_8 td_mb_16">Free Demo Class
                                </h3>
                    ...
                    <div class="td_iconbox td_style_2 text-center td_hobble">
                        <div class="td_iconbox_in td_hover_layer_4">
                            <div class="td_hover_layer_3">
                                ...
                                <h3 class="td_iconbox_title td_fs_20 td_semibold td_opacity_8 td_mb_16">Free University
                                    PYQ</h3>
                                <a href="register.php" class="td_iconbox_subtitle mb-0 td_accent_color">Register Now</a>
                            </div>
                        </div>
                    ...
                    <div class="td_iconbox td_style_2 text-center td_hobble">
                        <div class="td_iconbox_in td_hover_layer_4">
                            <div class="td_hover_layer_3">
                                ...
                                <h3 class="td_iconbox_title td_fs_20 td_semibold td_opacity_8 td_mb_16">Free Counselling
                                </h3>
                                <a href="register.php" class="td_iconbox_subtitle mb-0 td_accent_color">Register Now</a>
                            </div>
                        </div>
    ...
    <!-- Divider Line with Background Color -->
    <!-- Stylish Divider -->
                    ...
                    <div class="td_card td_style_1 td_type_3">
                        <div class="td_card_info">
                            <div class="td_card_info_in">
                                <h3 class="td_fs_32 td_mb_20">Master Your Bank PO & SSC Journey</h3>
                                <p class="td_mb_30 td_fs_18">
                                    Bank PO and SSC exams are the gateway to prestigious careers in the banking and
                                    government sectors. Exams like IBPS PO, SBI PO, and SSC CGL require rigorous
                                    preparation in Quantitative Aptitude, Reasoning, and General Awareness. With limited
                                    vacancies and high competition, structured guidance is essential. INFOMATHS INDIA,
                                    with its proven track record, offers comprehensive coaching programs designed to
                                    help aspirants crack these exams with confidence and secure top ranks.
                                </p>

                                <!-- Syllabus Section -->


                                <!-- Explore Top Exams Section (Header + Course Profile Grid) -->


                                <!-- Course Profile Section (Header + Text + Entrance Exams Grid) -->
                                <h3 class="td_fs_20 td_mb_20"
                                    style="color: #000033; font-weight: 700; text-transform: uppercase;">Check our
                                    Courses for Bank PO & SSC</h3>
                                <p class="td_mb_30 td_fs_18">
                                    Prepare for the most sought-after banking and government exams with our specialized
                                    coaching programs.
                                    We cover a wide range of entrance exams including IBPS, SBI, and SSC, ensuring you
                                    have the best preparation to succeed.
                                </p>

                                <!-- Swapped In: Entrance Exams Grid & Style -->
                                <style>
                                .exam-card {
                                    background: #fff;
                                ...
                                <div class="row g-4 mb-4">
                                    ...
                                    <?php 
                                        ...
                                        foreach ($entranceExams as $exam): 
                                            $courseCount++;
                                            $isHidden = $courseCount > 6;
                                            $extraClass = $isHidden ? 'extra-course' : '';
                                            $style = $isHidden ? 'style="display:none;"' : '';
                                        ?>
                                    <div class="col-md-6 col-lg-6 mb-4 <?php echo $extraClass; ?>"
                                        <?php echo $style; ?>>
                                        <div class="exam-card">
                                            ...
                                            <h4 class="exam-title"><?php echo htmlspecialchars($exam['exam_name']); ?>
                                            </h4>
                                            <a href="bank-po-exam/<?php echo htmlspecialchars($exam['slug']); ?>"
                                    ...
                                    <?php if (count($entranceExams) > 6): ?>
                                    <div class="col-12 text-center mt-3">
                                        <button id="showMoreCoursesBtn"
                                    ...
                                    document.getElementById('showMoreCoursesBtn').addEventListener('click', function() {
                                        var hiddenCourses = document.querySelectorAll('.extra-course');
                                        ...
                                        <div class="col-lg-12 wow fadeInUp" data-wow-duration="1s"
                                            ...
                                            <div class="td_section_heading td_style_1 td_mb_30">
                                                ...
                                                <p class="td_section_subtitle td_fs_18 mb-4">
                                                    At Infomaths, we combine expertise, innovation, and personalized
                                                    mentorship to help
                                                    students achieve top ranks in competitive exams. Our commitment to
                                                    excellence and
                                                ...
                                                <ul style="list-style:none;padding:0;margin:0 0 1.5rem 0;">
                                                    <li style="margin-bottom:1rem;display:flex;align-items:flex-start;">
                                                        ...
                                                        <span><strong>Proven Track Record</strong><br>
                                                            Consistently producing top ranks in NIMCET, MAHCET, PU MCA,
                                                            IIT JAM, and
                                                    ...
                                                    <li style="margin-bottom:1rem;display:flex;align-items:flex-start;">
                                                        ...
                                                        <span><strong>Expert Faculty & Mentorship</strong><br>
                                                            Learn from experienced educators with deep subject knowledge
                                                            and
                                                    ...
                                                    <li style="margin-bottom:1rem;display:flex;align-items:flex-start;">
                                                        ...
                                                        <span><strong>Comprehensive Learning Programs</strong><br>
                                                            Structured courses, mock tests, doubt-clearing sessions, and
                                                            study material
                                                    ...
                                                    <!-- <li style="margin-bottom:1rem;display:flex;align-items:flex-start;">
                                                        ...
                                                        <span><strong>Online & Offline Flexibility</strong><br>
                                                            Attend live classes or access recorded sessions anytime,
                                                            anywhere.</span>
                                                    </li> -->
                                                </ul>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="td_card td_style_6 td_white_bg td_radius_10" style="padding: 40px 30px;">
                        ...
                        <h3 class="td_fs_20 td_semibold td_mb_10 mt-3">
                            Daily Current Affairs <span class="news-icon"><i class="fas fa-newspaper"></i></span>
                        </h3>
                        <div class="notice-box">
                            <ul class="notice-vertical">
                                ...
                                $notices = [];
                                try {
                                    $stmt = $pdo->query("SELECT * FROM bank_po_notices WHERE is_active = 1 ORDER BY display_order ASC, created_at DESC");
                    ...
                    <div class="td_card td_style_6 td_white_bg td_radius_10"
                        ...
                        <h3 class="td_fs_20 td_semibold td_mb_10 mt-3">
                            Latest Banking Jobs <span class="news-icon"><i class="fas fa-briefcase"></i></span>
                        </h3>
                        <div class="notice-box">
                            <ul class="notice-vertical">
                                <?php
                                $jobs = [];
                                try {
                                    $stmt = $pdo->query("SELECT * FROM bank_po_jobs WHERE is_active = 1 ORDER BY display_order ASC, created_at DESC");
                                ...
                                ?>
                                <li><a href="#">No new job openings.</a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="megaleap-box-dark mb-4 mt-4"
                        ...
                        <div style="position: relative; z-index: 2;">
                            ...
                            <p class="mb-4" style="color: rgba(255,255,255,0.9); font-size: 15px; line-height: 1.6;">
                                Join <strong>INFOMATHS' BANKING PRO</strong> — the premier course designed for Bank PO &
                                SSC aspirants.
                                <br><br>
                                <span
            ...
            <div class="td_slider td_style_1 td_slider_gap_24 wow fadeInUp" data-wow-duration="1s"
                ...
                <div class="td_slider_container" data-autoplay="1" data-loop="1" data-speed="800" data-center="0"
                    ...
                    <div class="td_slider_wrapper">
                        ...
                        try {
                            $stmt = $pdo->prepare("SELECT * FROM toppers WHERE category = 'Bank PO' ORDER BY uploaded_at DESC");
                            $stmt->execute();
            ...
            <div class="container app-container_custom">
                ...
                <div class="td_cta_text_custom">
                    <div class="td_section_heading_custom">
                        <p class="td_section_subtitle_custom">MOBILE APPLICATION @CoursEdu</p>
                        ...
                        <p class="td_section_description_custom" style="color:white;">
                            <strong style="color:#4da3ff">Videos:</strong> Classroom & Strategy<br>
                            <strong style="color:#4da3ff">Articles:</strong> Academic & Value added info.<br>
                            <strong style="color:#4da3ff">Alerts:</strong> College & Tests Alerts<br>
                            <strong style="color:#4da3ff">Tests:</strong> Booking & Analysis<br>
                            <strong style="color:#4da3ff">Results:</strong> Test Results<br>
                            <strong style="color:#4da3ff">Workshops:</strong> Book E-Lectures/Workshops
                        </p>
    ...
    <section class="td_gray_bg_3">
        <div class="container" style="padding: 80px 0;">
            ...
            <div class="row td_gap_y_30">
                <?php
                try {
                    $stmt = $pdo->prepare("SELECT * FROM demo_lectures WHERE page_name = 'bank_po' AND is_active = 1 ORDER BY display_order ASC LIMIT 4");
                    $stmt->execute();
