...
try {
    ...
    $sql = "SELECT title as course_name, is_active FROM bca_course_profiles WHERE is_active = 1 ORDER BY display_order ASC, title ASC";
    $stmt = $pdo->query($sql);
...
$pageContent = [];
try {
    $stmt = $pdo->query("SELECT content_key, title, content_value FROM bca_content");
...
<head>
    ...
    <!-- Site Title -->
    <title>Career Options After BCA | Infomaths</title>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mb-5 mb-lg-0 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="pro-breadcrumb">
                        ...
                        <span class="pro-breadcrumb-item active">Career Options After BCA</span>
                    </div>
                ...
                <div class="col-lg-5 col-xl-4 ms-auto wow fadeInRight" data-wow-delay="0.4s">
                    <div class="glass-form-card">
                        ...
                        <form action="#" method="POST" id="proHeroForm" class="unified-contact-form">
                            ...
                            <input type="hidden" name="course_interest" value="BCA">
                ...
                <div class="col-lg-8">
                    <div class="td_card td_style_1 td_type_3">
                        <div class="td_card_info">
                            ...
                            $page_tabs = [];
                            try {
                                $stmt_tabs = $pdo->prepare("SELECT * FROM bca_page_tabs WHERE is_active = 1 ORDER BY display_order ASC");
                                $stmt_tabs->execute();
                    ...
                    <div class="td_card td_style_6 td_white_bg td_radius_10" style="padding: 40px 30px;">
                        ...
                        <div class="notice-box">
                            <ul class="notice-vertical">
                                ...
                                $notices = [];
                                try {
                                    $stmt = $pdo->query("SELECT * FROM bca_notices WHERE is_active = 1 ORDER BY display_order ASC, created_at DESC");
                    ...
                    <div class="td_card td_style_6 td_white_bg td_radius_10"
                        ...
                        <div class="notice-box">
                            <ul class="notice-vertical">
                                ...
                                $jobs = [];
                                try {
                                    $stmt = $pdo->query("SELECT * FROM bca_jobs WHERE is_active = 1 ORDER BY display_order ASC, created_at DESC");
            ...
            <div class="td_slider td_style_1 td_slider_gap_24 wow fadeInUp" data-wow-duration="1s"
                ...
                <div class="td_slider_container" data-autoplay="1" data-loop="1" data-speed="800" data-center="0"
                    ...
                    <div class="td_slider_wrapper">
                        ...
                        try {
                            $stmt = $pdo->prepare("SELECT * FROM toppers WHERE category = 'BCA' ORDER BY uploaded_at DESC");
                            $stmt->execute();
    ...
    <section class="td_gray_bg_3">
        <div class="container" style="padding: 80px 0;">
            ...
            <div class="row td_gap_y_30">
                <?php
                try {
                    $stmt = $pdo->prepare("SELECT * FROM demo_lectures WHERE page_name = 'bca' AND is_active = 1 ORDER BY display_order ASC LIMIT 4");
                    $stmt->execute();
