...
try {
    ...
    $sql = "SELECT title as course_name, is_active FROM csir_net_course_profiles WHERE is_active = 1 ORDER BY display_order ASC, title ASC";
    $stmt = $pdo->query($sql);
...
$pageContent = [];
try {
    $stmt = $pdo->query("SELECT content_key, title, content_value FROM csir_net_content");
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        $pageContent[$row['content_key']] = $row;
    }
} catch (Exception $e) {
    // Ignore
}
...
<head>
    ...
    <!-- Site Title -->
    <title>Best Coaching for CSIR NET / JRF | Infomaths</title>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mb-5 mb-lg-0 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="pro-breadcrumb">
                        ...
                        <span class="pro-breadcrumb-item active">CSIR NET / JRF</span>
                    </div>
                ...
                <div class="col-lg-5 col-xl-4 ms-auto wow fadeInRight" data-wow-delay="0.4s">
                    <div class="glass-form-card">
                        ...
                        <form action="#" method="POST" id="proHeroForm" class="unified-contact-form">
                            ...
                            <input type="hidden" name="course_interest" value="CSIR NET">
                        ...
                        <div class="td_card_info">
                            ...
                            @media (max-width: 768px) {
                                ...
                                .custom-tabs .nav-link {
                                    ...
                                    margin-right: 0;
                                    background: #fff;
                                    /* White background for inactive mobile tabs */
                                }
                            ...
                            $page_tabs = [];
                            try {
                                $stmt_tabs = $pdo->prepare("SELECT * FROM csir_net_page_tabs WHERE is_active = 1 ORDER BY display_order ASC");
                                $stmt_tabs->execute();
                            ...
                            <div class="td_card_info_in">
                                ...
                                <ul class="nav nav-pills custom-tabs mb-0" id="mainPageTabs" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link <?php echo $key === 0 ? 'active' : ''; ?>"
                                            id="tab-btn-<?php echo $tab['id']; ?>" data-bs-toggle="tab"
                                            data-bs-target="#tab-content-<?php echo $tab['id']; ?>" type="button"
                                            role="tab" aria-controls="tab-content-<?php echo $tab['id']; ?>"
                                            aria-selected="<?php echo $key === 0 ? 'true' : 'false'; ?>"><?php echo htmlspecialchars($tab['tab_title']); ?></button>
                                    </li>
                                    <?php endforeach; ?>
                                </ul>
                                ...
                                <div class="tab-content tab-content-area" id="mainPageTabsContent">
                                    ...
                                    <div class="tab-pane fade <?php echo $key === 0 ? 'show active' : ''; ?>"
                                        id="tab-content-<?php echo $tab['id']; ?>" role="tabpanel"
                                        aria-labelledby="tab-btn-<?php echo $tab['id']; ?>">
                                        <h3 class="td_fs_32 td_mb_20"><?php echo htmlspecialchars($tab['tab_title']); ?>
                                        </h3>
                                        <div class="td_mb_30 td_fs_18">
                    ...
                    <div class="td_card td_style_6 td_white_bg td_radius_10" style="padding: 40px 30px;">
                        ...
                        <div class="notice-box">
                            <ul class="notice-vertical">
                                ...
                                $notices = [];
                                try {
                                    $stmt = $pdo->query("SELECT * FROM csir_net_notices WHERE is_active = 1 ORDER BY display_order ASC, created_at DESC");
                    ...
                    <div class="td_card td_style_6 td_white_bg td_radius_10"
                        ...
                        <div class="notice-box">
                            <ul class="notice-vertical">
                                ...
                                $jobs = [];
                                try {
                                    $stmt = $pdo->query("SELECT * FROM csir_net_jobs WHERE is_active = 1 ORDER BY display_order ASC, created_at DESC");
            ...
            <div class="td_slider td_style_1 td_slider_gap_24 wow fadeInUp" data-wow-duration="1s"
                ...
                <div class="td_slider_container" data-autoplay="1" data-loop="1" data-speed="800" data-center="0"
                    ...
                    <div class="td_slider_wrapper">
                        ...
                        try {
                            $stmt = $pdo->prepare("SELECT * FROM toppers WHERE category = 'CSIR NET' ORDER BY uploaded_at DESC");
                            $stmt->execute();
    ...
    <section class="td_gray_bg_3">
        <div class="container" style="padding: 80px 0;">
            ...
            <div class="row td_gap_y_30">
                <?php
                try {
                    $stmt = $pdo->prepare("SELECT * FROM demo_lectures WHERE page_name = 'csir_net' AND is_active = 1 ORDER BY display_order ASC LIMIT 4");
                    $stmt->execute();
