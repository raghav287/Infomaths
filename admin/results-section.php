...
try {
    $stmt = $pdo->prepare("SELECT * FROM section_images WHERE section_name IN ('mca_results', 'pu_results', 'campus_placement', 'college_results', 'iit_jam_gallery') ORDER BY section_name, display_order");
    $stmt->execute();
