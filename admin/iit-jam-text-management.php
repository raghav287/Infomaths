...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_content'])) {
    ...
    try {
        $stmt = $pdo->prepare("UPDATE iit_jam_content SET title = ?, content_value = ? WHERE id = ?");
...
// Fetch content
try {
    $stmt = $pdo->query("SELECT * FROM iit_jam_content ORDER BY id ASC");
...
<head>
    ...
    <meta name="description" content="Info Maths Online admin dashboard - Manage IIT JAM Content">
    
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="../assets/img/favicon.png">

    <!-- TITLE -->
    <title>Manage IIT JAM Content</title>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Manage IIT JAM Text Content</h1>
                            <div>
                                <ol class="breadcrumb">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        try {
                                            $stmt = $pdo->prepare("SELECT * FROM iit_jam_content WHERE section_key = 'main_content'");
                                            $stmt->execute();
