    ...
    if (isset($_POST['display_order']) && is_array($_POST['display_order'])) {
        try {
            ...
            foreach ($_POST['display_order'] as $image_id => $display_order) {
                $stmt = $pdo->prepare("UPDATE section_images SET display_order = ? WHERE id = ? AND section_name = ?");
                $stmt->execute([(int)$display_order, (int)$image_id, 'why choose us']);
            }
            $pdo->commit();
...
// Fetch why choose us section images
try {
    $stmt = $pdo->prepare("SELECT * FROM section_images WHERE section_name = ? ORDER BY id");
    $stmt->execute(['why choose us']);
...
<head>
    ...
    <!-- TITLE -->
    <title>Info Maths Online - Why Choose Us Section Images</title>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Why Choose Us Section Images</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Why Choose Us Images</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Upload Why Choose Us Section Image</h3>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <form method="POST" enctype="multipart/form-data" class="mb-4">
                                            <div class="row">
                                                <input type="hidden" name="section_name" value="why choose us">
                                        ...
                                        <?php if (!empty($section_images)): ?>
                                            <div class="section-header mb-3">
                                                <h4>Why Choose Us Section Images</h4>
                                            </div>
                                        ...
                                        <?php else: ?>
                                            <div class="alert alert-info">
                                                <i class="fa fa-info-circle"></i> No Why Choose Us section images found. Upload some images to get started.
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
