...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_content'])) {
    ...
    try {
        $stmt = $pdo->prepare("UPDATE csir_net_content SET title = ?, content_value = ? WHERE id = ?");
...
// Fetch content
try {
    $stmt = $pdo->query("SELECT * FROM csir_net_content ORDER BY id ASC");
...
<head>
    ...
    <meta name="description" content="Info Maths Online admin dashboard - Manage CSIR NET Content">
    
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="../assets/img/favicon.png">

    <!-- TITLE -->
    <title>Manage CSIR NET Content</title>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Manage CSIR NET Text Content</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                    <li class="breadcrumb-item">CSIR NET Page</li>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        try {
                                            $stmt = $pdo->prepare("SELECT * FROM csir_net_content WHERE content_key = 'main_content'");
                                            $stmt->execute();
