        ...
        if (in_array($file_ext, $allowed_exts)) {
            ...
            if (move_uploaded_file($file_tmp, $upload_path)) {
                try {
                    ...
                    header("Location: csir-net-toppers-management.php?success=1");
                    exit;
...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    try {
        ...
        if ($record && $record['category'] == $PAGE_CATEGORY) {
            ...
            header("Location: csir-net-toppers-management.php?deleted=1");
            exit;
        } else {
...
<head>
    ...
    <meta name="description" content="Info Maths Online admin dashboard - Manage CSIR NET Toppers.">
    
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="../assets/img/favicon.png">

    <!-- TITLE -->
    <title>Info Maths Online - CSIR NET Toppers Management</title>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">CSIR NET Toppers Management</h1>
                            <div>
                                <ol class="breadcrumb">
                                        ...
                                        <form method="post" enctype="multipart/form-data" class="mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="description" class="form-control" placeholder="e.g. AIR 1 - CSIR NET 2024">
                                                </div>
                                                <div class="col-md-4">
