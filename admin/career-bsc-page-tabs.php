...
<head>
    ...
    <title>Manage Career BSC Page Tabs</title>
                ...
                <div class="side-app">
                    <div class="main-container container-fluid">
                        <div class="page-header">
                            <h1 class="page-title">Manage Career BSC <span class="text-primary">Page Tabs</span></h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="panel">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Career BSC Tabs</li>
                                </ol>
                            </div>
                        </div>
