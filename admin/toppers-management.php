...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    $id = (int)$_GET['delete'];
    try {
        // Check if the record exists and is not a MEDIA category (to prevent deleting media from toppers management)
        $stmt = $pdo->prepare("SELECT image_path, category FROM toppers WHERE id = ?");
        $stmt->execute([$id]);
        $record = $stmt->fetch();
        
        if ($record && $record['category'] != 'MEDIA') {
            ...
            $error_message = "Cannot delete this record from toppers management.";
        }
    } catch (PDOException $e) {
...
// Fetch all toppers (excluding MEDIA category)
try {
...
<head>
    ...
    <meta name="description" content="Manage toppers gallery for NIMCET, MAHCET, VIT, and PU toppers on Info Maths Online admin panel.">
    <meta name="keywords" content="toppers management, NIMCET toppers, MAHCET toppers, VIT toppers, PU toppers, admin panel">
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="../assets/img/favicon.png">

    <!-- TITLE -->
    <title>Info Maths Online - Toppers Gallery Management</title>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Toppers Gallery Management</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Toppers Gallery</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select name="category" class="form-control" required>
                                                        ...
                                                        <option value="IIT JAM">IIT JAM TOPPERS</option>
                                                        <option value="NIMCET">NIMCET TOPPERS</option>
                                                        <option value="MAHCET">MAHCET TOPPERS</option>
                                                        <option value="VIT">VIT TOPPERS</option>
                                                        <option value="PU">PU TOPPERS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><?php 
                                                                    if ($topper['category'] == 'MEDIA') {
                                                                        echo 'Infomaths in PRINT / MEDIA / Career Counselling';
                                                                    } else {
                                                                        echo htmlspecialchars($topper['category']) . ' TOPPERS';
                                                                    }
                                                                ?></td>
                                                                <td><?php echo date('j M Y', strtotime($topper['uploaded_at'])); ?></td>
                                                                <td>
